...
export const jobOpenings = [
  {
    ...
    requirements: [
      ...
      "Experience in data analysis and DC Park projects is a plus.",
    ],
  ...
  },
  {
    ...
    requirements: [
      ...
      "Experience in DC Park projects and infrastructure development.",
  ...
  },
  {
    ...
    description:
      "We are seeking an experienced Project Manager to oversee the planning, execution, and delivery of DC Park projects.",
    requirements: [
